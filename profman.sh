...
#
# BEST PRACTICES:
# After deploying changes, start Vivaldi and then perform a clean shutdown
# (File > Exit). This ensures Vivaldi saves your new settings as its "last
# known good" state, preventing an accidental overwrite after a future crash.
